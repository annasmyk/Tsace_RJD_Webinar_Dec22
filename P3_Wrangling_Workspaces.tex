...
Later we will produce the same ws result with
...
\item
  ...
  GUI but with R
\item
  keep the reading, writing and refreshing properties both by the
  graphical interface and by the cruncher
\item
...
\hypertarget{handling-several-ws}{%
\subsection{Handling several WS}\label{handling-several-ws}}

\begin{frame}[fragile]{Handling several WS}
\begin{itemize}
\item
...
Unfortunately, the creation of ws is not totally elaborated and
