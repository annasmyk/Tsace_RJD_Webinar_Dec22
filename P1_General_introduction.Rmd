...
They all require Java `r fa_java` $\geq$ 17 
(see for example installation manual of `RJDemetra`: <https://github.com/jdemetra/rjdemetra/wiki/Installation-manual>)
...
```{r, include=TRUE, eval=FALSE}
install.packages(RJDemetra) #maj
library(RJDemetra)
```
