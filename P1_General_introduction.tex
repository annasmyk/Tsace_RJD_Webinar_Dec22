...
Extension of scope: - High-frequency data (extended) - STL - refresh
policies for SA - new tools
...
\item
  additionnal packages based on RJDemetra: rjdworkspace, ggdemetra,
  rjdqa (see paper on V2)
\item
...
\begin{itemize}
\item
  outline main features for SA with JDemetra+ in R (using X13-Arima and
  Tramo-Seats)
\item
  highlight the differences from version 2 to version 3
\end{itemize}
\end{frame}
