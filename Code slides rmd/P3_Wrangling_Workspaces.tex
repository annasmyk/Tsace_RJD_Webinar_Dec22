...
\hypertarget{using-workspaces-and-r-packages-in-conjunction}{%
\section{Using workspaces and R packages in
conjunction}\label{using-workspaces-and-r-packages-in-conjunction}}

\begin{frame}{Using workspaces and R packages in conjunction}
\protect\hypertarget{using-workspaces-and-r-packages-in-conjunction-1}{}
