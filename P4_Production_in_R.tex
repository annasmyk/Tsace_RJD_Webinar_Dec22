...
Presentation 4: SA production and quality assessment in R}
...
\begin{frame}{Why production in R}
\protect\hypertarget{why-production-in-r}{}
a question (request wich comes back all the time) why ?
\end{frame}
...
\section{Refreshing data}\label{refreshing-data}}

\begin{frame}{Refresh policies available}
\protect\hypertarget{refresh-policies-available}{}
cruncher
\end{frame}

\hypertarget{quality-assessment-of-a-data-set-jdcruncher}{%
\section{Quality assessment of a data set
(JDCruncher)}\label{quality-assessment-of-a-data-set-jdcruncher}}

\hypertarget{conclusion}{%
\section{Conclusion}\label{conclusion}}

\hypertarget{on-production-in-r}{%
\subsection{On production in R}\label{on-production-in-r}}
